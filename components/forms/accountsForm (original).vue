...
<script setup>
	...
	// form handlers
	//
	const changeLocation = (fieldset) => {
		console.log(
			'fiels.account_addr_country, fiels.account_addr_state',
			fieldset.account_addr_country,
			fieldset.account_addr_state
		)
		state.value.account_addr_country = fieldset.account_addr_country
		state.value.account_addr_state = fieldset.account_addr_state
	}
